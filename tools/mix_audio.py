...
SFX = [
    ...
    # S2 keyword filter
    ('sfx_scan_sweep.mp3', 270, -17, [0.0, 2.2], 0.5),
    ...
    ('sfx_toast_pop.mp3', 1352, -8, [0.0, 1.0], 0.2),
    # S7 climax
    ('sfx_riser.mp3', 1456, -14, [0.0, 2.1], 0.05),  # riser ends on the first word (transient = end, see below)
